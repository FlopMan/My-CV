    ...
    return (
        ...
        >
            <div className="flex justify-between items-center mb-[1.17rem] text-[#fff]">
                <p className="text-[1.46413rem]  leading-[1.1] max-md:tracking-[-0.07321rem]">
                    Jenny Nguyen
                </p>
                <svg
                    onClick={() => {
            ...
            <div className="grid grid-cols-1 gap-[1.17rem] text-[#fff]">
                {links.map((item) => (
                    <Link
                        ...
                        className="text-[1.1713rem] font-semibold leading-[1.5] text-center"
                ...
                <Link
                    className=" text-[1.1713rem] font-semibold leading-[1.5] text-center flex items-center justify-center"
                    href="/"
                >
                    Contact
                    <svg
                        className="w-[1.75695rem] h-[1.75695rem] object-contain ml-[0.59rem]"
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="24"
                        viewBox="0 0 25 24"
                    ...
                    >
                        <path
                            d="M5.5 12H19.5M19.5 12L12.5 19M19.5 12L12.5 5"
                            stroke="white"
                            stroke-width="2"
