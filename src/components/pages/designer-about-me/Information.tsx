...
export default function Information() {
    ...
    return (
        <div className="md:w-[27.91667rem] w-full md:mr-[5rem] flex-shrink-0 max-md:hidden">
            <div className="w-full md:sticky md:top-[7.5rem]">
                <Image
                    src={"/assets/images/pagess/avt.png"}
                    alt="avt"
                    width={400}
                    height={400}
                    className="w-full h-[31.25rem] object-cover rounded-[2.22222rem] mb-[1.39rem]"
                />

                <div
                    className={`grid grid-cols-1 border gap-[1.11rem] w-[full] rounded-[1.38889rem] bg-[#fff] p-[1.67rem] ${border}`}
                >
