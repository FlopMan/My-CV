...
const items: WorkItemType[] = [
    {
        thumbs: [
            "/assets/images/designer/work_1.png",
            "/assets/images/designer/work_1.png",
            "/assets/images/designer/work_1.png",
            "/assets/images/designer/work_1.png",
        ],
...
const MainProjects = () => {
    ...
    return (
        <div className="md:p-[6.67rem] p-[1.39rem] max-md:pt-[7rem]">
            <h1 className="md:text-center text-[#272626] max-md:text-theme-primary text-[2.22222rem] md:text-[5rem] font-semibold leading-[1.2] mb-[2.22rem] md:mb-[3.89rem] uppercase">
                Featured works
            </h1>
